...
ThemeData appTheme = ThemeData(
    ...
    /* Colors.tealAccent,*/
    secondaryHeaderColor:Colors.pinkAccent.shade100 /* Colors.teal*/
    // fontFamily:
    );
    ...
    return Stack(
      children: <Widget>[
        ClipPath(
          clipper: Clipper08(),
          child: Container(
            height: height! * .50 < 450 ? height! * .50 : 500, //400
...
var homeDown = Column(
  children: <Widget>[
    ...
    Container(
      height: height! * .25 < 170 ? height! * .35 : 170,
            ...
            child: Stack(
              children: <Widget>[
                Padding(
                  ...
                  child: Container(
                    height: height! * .179 < 180 ? height! * .179 : 160,
                    width: width! * .7 < 250 ? width! * .7 : 250,
